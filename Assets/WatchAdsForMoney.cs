...
public class WatchAdsForMoney : RewardedVideo
{
    ...
    private string rewardedId = "ca-app-pub-4962234576866611/4816038329";

    private string gameID="3507083";
#else
    private string appId = "ca-app-pub-4962234576866611~2606708192";
    private string rewardedId = "ca-app-pub-4962234576866611/3502956653";

    private string gameID="3507082";
#endif
